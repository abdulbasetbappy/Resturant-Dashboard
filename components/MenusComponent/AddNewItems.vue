  ...
  <div class="card flex justify-content-center">
    ...
    >
      <form @submit.prevent="handleSubmit">
        ...
        <div
          class="mb-4 mt-1 border relative border-dashed border-gray-300 rounded-lg text-center h-64"
          @dragover.prevent
      ...
      <div class="flex justify-between items-center mt-2">
        ...
        <button
          type="submit"
          class="bg-gray-500 px-3 py-2 text-white rounded-md flex items-center justify-center"
        >
